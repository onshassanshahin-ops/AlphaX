      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl">
            <span className="text-gold text-sm font-semibold uppercase tracking-widest">Updates</span>
            <h1 className="text-4xl sm:text-5xl font-bold font-grotesk text-white mt-3 mb-4">
              Announcements
            </h1>
            <p className="text-slate-400 text-lg">
              Stay up to date with the latest news, events, and opportunities from AlphaX.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {regular.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-xl font-grotesk text-slate-400">No announcements yet</p>
            </div>
          ) : null}
        </div>
      </section>
